...
def get_monitor_scheduler(
    HTTP_monitor_service: HTTP_monitorService = Depends(get_HTTP_monitor_service),
    API_monitor_service: API_monitorService = Depends(get_API_monitor_service),
    monitor_service: MonitorService = Depends(get_monitor_service)):
    return MonitorScheduler(
        HTTP_monitor_service,
        API_monitor_service,
        monitor_service,
    )