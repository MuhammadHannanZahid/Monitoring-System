...
from app.modules.HTTP_monitor.dependencies import get_website_repository
...
def get_monitor_service(website_repository: HTTP_monitorRepository = Depends(get_website_repository), incident_service: IncidentService = Depends(get_incident_service), monitor_result_service: MonitorResultService = Depends(get_monitor_result_service)) -> MonitorService:
